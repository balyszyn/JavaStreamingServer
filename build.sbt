...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.akka" %% "akka-cluster-metrics" % "2.6.15",
  "com.typesafe.akka" %% "akka-cluster-sharding" % "2.6.15",
  "com.typesafe.akka" %% "akka-cluster-tools" % "2.6.14",
  "com.typesafe.akka" %% "akka-distributed-data" % "2.6.15",
  ...
  "com.typesafe.akka" %% "akka-persistence-tck" % "2.6.14",
  ...
  "com.typesafe.akka" %% "akka-testkit" % "2.6.15",
