...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.play" %% "play-ws-standalone-xml" % "2.1.3",
  ...
  "com.typesafe.akka" %% "akka-cluster-metrics" % "2.6.14",
  "com.typesafe.akka" %% "akka-cluster-sharding" % "2.6.14",
  "com.typesafe.akka" %% "akka-cluster-tools" % "2.6.14",
  "com.typesafe.akka" %% "akka-distributed-data" % "2.6.14",
  "com.typesafe.akka" %% "akka-multi-node-testkit" % "2.6.14",
  "com.typesafe.akka" %% "akka-osgi" % "2.6.14",
  "com.typesafe.akka" %% "akka-persistence" % "2.6.13",
  "com.typesafe.akka" %% "akka-persistence-query" % "2.6.13",
  "com.typesafe.akka" %% "akka-persistence-tck" % "2.6.13",
