...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.akka" %% "akka-cluster-metrics" % "2.6.11",
  "com.typesafe.akka" %% "akka-cluster-sharding" % "2.6.11",
  "com.typesafe.akka" %% "akka-cluster-tools" % "2.6.11",
  "com.typesafe.akka" %% "akka-distributed-data" % "2.6.11",
  "com.typesafe.akka" %% "akka-multi-node-testkit" % "2.6.11",
  "com.typesafe.akka" %% "akka-osgi" % "2.6.11",
  "com.typesafe.akka" %% "akka-persistence" % "2.6.11",
  "com.typesafe.akka" %% "akka-persistence-query" % "2.6.11",
  "com.typesafe.akka" %% "akka-persistence-tck" % "2.6.11",
  "com.typesafe.akka" %% "akka-remote" % "2.6.11",
  "com.typesafe.akka" %% "akka-slf4j" % "2.6.11",
  "com.typesafe.akka" %% "akka-stream" % "2.6.11",
  "com.typesafe.akka" %% "akka-stream-testkit" % "2.6.11",
